...
public sealed class SmartVirtualize<TItem>
    : ComponentBase,
        ISmartVirtualizeJsCallbacks,
        IAsyncDisposable
{
    ...
    void ISmartVirtualizeJsCallbacks.OnBeforeSpacerVisible(
        float spacerSize,
    ...
    void ISmartVirtualizeJsCallbacks.OnAfterSpacerVisible(
        float spacerSize,
        float spacerSeparation,
        float containerSize
    )
    ...
    )
    {
        ...
        var maxItemCount = AppContext.GetData(
            "Microsoft.AspNetCore.Components.Web.Virtualization.Virtualize.MaxItemCount"
        ) switch
        {
    ...
    private void UpdateItemDistribution(
        int itemsBefore,
